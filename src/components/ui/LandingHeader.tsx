...
const LandingHeader = () => {
  ...
  return (
    ...
    <>
      ...
      <div className="mobile-menu-area block lg:hidden ">
              ...
              <ul
                ...
                <li>
                  ...
                  <ul
                    ...
                    <li>
                      <a href="index-2.html">Finance Consulting</a>
                    </li>
                    <li>
                      <a href="index-3.html">IT Solution</a>
                    </li>
                    <li>
                      <a href="landing-1.html">
                        Landing One<span>New</span>
                      </a>
                    </li>
                    <li>
                      <a href="landing-2.html">
                        Landing Two<span>New</span>
                      </a>
                    </li>
                  </ul>
                  <a
                ...
                <li>
                  ...
                  <ul
                    ...
                    <li>
                      <a href="blog-2column.html">Blog-2Column</a>
                    </li>
                    <li>
