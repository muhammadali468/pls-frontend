          ...
          <div className="grid lg:grid-cols-3 gap-6 mt-8">
            ...
            <div className="lg:col-span-2">
              ...
              <h1
                ...
                data-maxlength={50}
                className="editable text-2xl font-bold mb-4">
              ...
              <p
                ...
                suppressContentEditableWarning
                data-maxlength={84}
                className="editable text-gray-600 mb-6">
              ...
              <ul
                contentEditable
                className="grid grid-cols-2 gap-4 text-primary mb-6">
                <li
                  className="editable"
                  suppressContentEditableWarning
                  data-maxlength={36}>
              ...
              <div className="space-y-4">
                ...
                {[
                  ...
                  <details
                    ...
                    <summary
                      className="font-semibold text-lg editable"
                      contentEditable
                      suppressContentEditableWarning
                      data-maxlength={68}>
                      {faq.question}
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <form className="space-y-4">
                  ...
                  <button
                    disabled
                    className="w-full bg-primary text-white py-3 px-4 rounded-lg hover:bg-orange-600">
                    Ask Question Now
                  </button>
                </form>
              </div>
