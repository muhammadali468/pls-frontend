...
const ServiceDetailComponent = ({ singleServiceDetail }: { singleServiceDetail: ISINGLESERVICE }) => {
  ...
  // const [pageData, setPageData] = useState(singleServiceDetail.data.singleService.detailPage as string);

  // const pageDetail = singleServiceDetail.data.singleService.detailPage as string

  // const parsedPageDetail = JSON.parse(pageData) as ISINGLESERVICEDETAIL;
  const parsedPageDetail = JSON.parse(singleServiceDetail.data.singleService.detailPage as string) as ISINGLESERVICEDETAIL;
  ...
  const handleDetailUpdate = async () => {
    try {
      const res = await axios.patch(
        "/navigationPages/updateService",
        {
          id: singleServiceDetail.data.singleService.id,
          serviceDetail: JSON.stringify(parsedPageDetail)
        },
        {
          headers: {
  ...
  return (
    <>
      <section className="py-64">Current Detail Page of : {singleServiceDetail.data.singleService.id}</section>
              ...
              <div className="row">
                <div className="col-lg-12 col-sm-12">
                  <div className="consen-service-details-box flex flex-col">
                    ...
                    {parsedPageDetail.tabs.map((tab, i) => (
                      <TabPanel
                        key={i}
                ...
                <div className="grid sm:grid-cols-2 mt-8 ">
                  {parsedPageDetail.keyFeatures.map((keyFeature, i) => (
                    <div
                      key={i}
              ...
              <div className="col-lg-7 col-md-6 mt-8">
                <div className="service-details-icon-box">
                  ...
                  <div className="widget-service-details-icon mt-4">
                    ...
                    {parsedPageDetail.whyChooseUs.map((item, i) => (
                      <div
                        key={i}
                        className="flex gap-2">
                        <i className="bi bi-check-lg" />
        ...
        <div className="pb-16 mt-8">
          <div className="max-w-screen-2xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 w-full gap-8">
              {parsedPageDetail.processes.map((process, i) => (
                <div
                  key={i}
