...
const AddIndustryDetails = () => {
    const [image, setImage] = useState("/assets/images/industry/water-sector.jpg");
                ...
                <div className="container mx-auto p-5">
                    ...
                    <div className="grid lg:grid-cols-3 gap-6 mt-8">
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="mb-6">
                                <label htmlFor="file-input">
                                    <div className="relative group h-[25.938rem] max-w-full w-[45.313rem]">
                                        <Image
                                            // width={953}
                                            // height={546}
                                            fill
                                        ...
                                        />
                                        <div className="bg-[#00000062] hidden group-hover:flex gap-2 justify-center items-center duration-300 h-full w-full absolute">
                            ...
                            {/* Title Section */}
                            <h1 contentEditable suppressContentEditableWarning data-maxlength={50} className="editable text-2xl font-bold mb-4">North American Water Industry</h1>
                            <p contentEditable suppressContentEditableWarning data-maxlength={84} className="editable text-gray-600 mb-6">
                            ...
                            {/* Mission Section */}
                            <h2 contentEditable className="text-2xl font-bold mb-4">Smart Water Technology Market</h2>
                            <p contentEditable suppressContentEditableWarning data-maxlength={84} className="editable text-gray-600 mb-6">
                            ...
                            {/* Services Section */}
                            <h2 contentEditable suppressContentEditableWarning data-maxlength={50} className="editable text-2xl font-bold mb-4">Aging Infrastructure</h2>
                            <p contentEditable className="text-gray-600 mb-6">
                            ...
                            <h2 contentEditable suppressContentEditableWarning data-maxlength={50} className="editable text-2xl font-bold mb-4">Challenges</h2>
                            <ul contentEditable className="grid grid-cols-2 gap-4 text-primary mb-6">
                                <li className="editable" suppressContentEditableWarning data-maxlength={36} >Cybersecurity Risks</li>
                                <li className="editable" suppressContentEditableWarning data-maxlength={36}>Data Silos</li>
                                <li className="editable" suppressContentEditableWarning data-maxlength={36}>High Implementation Costs</li>
                                <li className="editable" suppressContentEditableWarning data-maxlength={36}>Regulatory Complexities</li>
                                <li className="editable" suppressContentEditableWarning data-maxlength={36}>Limited Public Awareness</li>
                                <li className="editable" suppressContentEditableWarning data-maxlength={36}>Digital Divide</li>
                            </ul>

                            {/* FAQ Section */}
                            <h2 contentEditable suppressContentEditableWarning data-maxlength={50} className="editable text-2xl font-bold mb-4">How we plugin our challenges</h2>
                            <div className="space-y-4">
                                ...
                                {[
                                    ...
                                    <details
                                        ...
                                        <summary className="font-semibold text-lg editable" contentEditable suppressContentEditableWarning data-maxlength={68}>{faq.question}</summary>
                                        {faq.answer}
                        ...
                        <div className="space-y-6">
                            {/* Categories Section */}
                            <div>
                                <h3 suppressContentEditableWarning data-maxlength={35} className="text-xl font-bold mb-4">Categories</h3>
                                <div className="space-y-4">
                                    {/* FAQ Items */}
                                    {[
                                        {
                                        ...
                                        <details
                                            ...
                                            <summary suppressContentEditableWarning data-maxlength={68} className="font-semibold text-lg">{faq.question}</summary>
                                            {faq.answer}
                                            {/* <p className="mt-2 text-gray-600">{faq.answer}</p> */}
                                        </details>
                                    ))}
                            ...
                            <div>
                                ...
                                <form className="space-y-4">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full p-3 border border-gray-300 rounded-lg"
                                        rows={4}></textarea>
                                    <button disabled className="w-full bg-primary text-white py-3 px-4 rounded-lg hover:bg-orange-600">Ask Question Now</button>
                                </form>
                            </div>
                        </div>
                    </div>
